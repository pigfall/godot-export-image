...
# Download exports template.
RUN curl -LO https://downloads.tuxfamily.org/godotengine/3.5/mono/Godot_v3.5-stable_mono_export_templates.tpz && unzip Godot_v3.5-stable_mono_export_templates.tpz

# Copy exports template to target directory
RUN mkdir -p /root/.local/share/godot/templates/3.5.stable.mono && cp templates/android_debug.apk /root/.local/share/godot/templates/3.5.stable.mono && cp templates/android_debug.apk /root/.local/share/godot/templates/3.5.stable.mono/android_release.apk
